...
export const aboutWorkItems = {
    dataViz: [
        {
            title: "Flowers and Tracks: A visual and cartographic exploration",
            subtitle: "ADB South Asia Department - Visualizing Climate Change & Resilience Challenge",
            desc: [`This data story invokes the readers curiosity regarding historical typhoon data in the west pacific region and how
            ...
            type: "Data Story",
            tools_tech: "Observable Notebook, D3.js, JavaScript",
            date: "",
        ...
        {
            title: "Intuition: 3D image analog explorer",
            subtitle: "Iraya Energies",
            desc: [`A feature that allows exploration of thousand image vectors simultaneously in 2D and 3D spaces. This feature
            determines image similarity according to their proximity in the dimensionally reduced space. This interface takes
            in 3D vector, vector scale, thumbnail image, and full resolution image as inputs that were accessed through an API`],
            type: "Application Feature",
            tools_tech: "deck.gl, JavaScript, Vue.js",
            date: "",
            award: "",
            images: [],
            links: []
        ...
        {
            title: "Document Wordcloud",
            subtitle: "Iraya Energies",
            desc: [`A feature that delivers insightful snapshots of reports, showcasing relevant tokens and eliminating noise.
        ...
        {
            title: "Search Result Heatmap",
            subtitle: "Iraya Energies",
            desc: [`A webGIS interface that spatially visualizes information richness, providing clear search query relevance and
            context. This interface takes in geotagged search results and their frequencies to interpolate and generate a raster
            canvas image for the currently displayed map boundaries highlighting hotspots.`],
            type: "Application Feature",
            tools_tech: "Leaflet.js, turf.js, JavaScript",
            date: "",
            award: "",
            images: [],
            links: []
        ...
        {
            title: "Well & Publication Knowledge Graph",
            subtitle: "Iraya Energies",
            desc: [`A network graph feature that unveils valuable insights into intricate relationships, guiding intuitive information
            discovery through exploration of the nodes and edges generated. This visualization takes in the JSON output of a
            separate Python script that creates the network from the corpus of extracted information.`],
            type: "Application Feature",
            tools_tech: "D3.js, JavaScript, Python, Gephi",
            date: "",
            award: "",
            images: [],
            links: []
        },
        {
            ...
            responses were used as prompts to generate a unique data portrait output.`],
            type: "Data Portrait",
            tools_tech: "Affinity Designer, p5.js, JavaScript, Python",
            date: "",
            award: "",
            images: [],
            links: []
        },
        {
            ...
            subtitle: "Data Visualization Society",
            ...
            listed motivations in the DVS survey.`],
            type: "Data Story",
            tools_tech: "Affinity Designer, Gephi",
            date: "",
            award: "",
            images: [],
            links: []
        },
        {
            ...
            desc: [`This visualization aims to convey the characteristics of the existing policies that the countries in the Western
            ...
            of data visualization and cartography.`],
            type: "Data Story",
            tools_tech: "QGIS, Python, Affinity Designer",
            date: "",
            award: "",
            images: [],
            links: []
        },
        {
            ...
            subtitle: "Viz for Social Good",
            desc: [`A contribution to Viz for Social Good's call to visualize the milestones of Crowd2Map Tanzania as they celebrate
            their 5th year. Viz for Social Good's challenge is to communicate the impact and achievements that Crowd2Map
            has had through engaging visualization. This data story used p5.js to generate data-driven illustrations.`],
            type: "Data Story",
            tools_tech: "p5.js, Affinity Designer, JavaScript, Python",
            date: "",
            award: "",
            images: [],
            links: []
        },
        {
            ...
            subtitle: "Asian Development Bank",
            desc: [`A winning entry to 2020's World Statistics Day data visualization and data story-telling challenge. The focus of this
            visualization and story both entitled: Trees of Innovation, was to depict the number of full-time researchers each
            country hired and related it to the R&D expenditure percentage of their GDP.`,
            `As defined by the data, the trees varied in height and the number of branches. For the fruits, the data defined the
size, number, and color of the fruits. Translating data parameters to the generated trees’ properties was made
possible through a p5.js script.`],
            type: "Data Visualization and Story",
            tools_tech: "p5.js, d3.js, Affinity Designer, JavaScript, Python",
            date: "",
            award: "1st Place Data Visualization, 2nd Place Data Story",
            images: [],
            links: []
        },
    ...
    product:[
        {
            title: "US-ASEAN Science, Innovation, and Technology Cooperation Program Fellow",
            subtitle: "Arizona State University",
            desc: [`• Represented the Philippines in this region-wide startup incubator program working to elevate an idea into an
            investment-ready desirable, feasible, and viable product through a fund-winning pitch to presented in
            Indonesia.`],
            type: "Virtual",
            tools_tech: "",
            date: "July 2023 - August 2023",
            award: "Finalist (Top 20)",
            images: [],
            links: []
        },
        {
            title: "YSEALI Technology and Innovation Fellow",
            subtitle: "YSEALI Academy at Fulbright University Vietnam",
            desc: [`• Represented the Philippines in the esteemed Young Southeast Asian Leaders Initiative fellowship, igniting
...
artifacts to propel our heritage into the future.`],
        ...
        {
            title: "Project Lead",
            subtitle: "Ausome Maps",
            desc: [`• Continues to make spaces and communities aware, understand, accept and take action for individuals Autism
...
accomplishment reports and vital documentation to showcase the project's impactful journey.`],
        ...
        },
        {
            ...
            subtitle: "Iraya Energies",
            desc: [`• Led the development and successful launch of Iraya's groundbreaking SaaS product, Data Atelier, opening new
...
partner relationships.`],
        ...
        },
        {
            ...
            subtitle: "Iraya Energies",
            desc: [`• Created comprehensive design assets, including mockups, flows, user stories, and blueprints, to drive further
...
engaging approaches.`],
        ...
        },
        {
            ...
            subtitle: "Iraya Energies",
            desc: [`• Spearheaded the ideation, creation, and development of ElasticDocs, a ground-breaking flagship product that
...
highly relevant and user-friendly, effectively meeting the evolving needs of our target audience.`],
            type: "Kuala Lumpur, Malaysia",
            tools_tech: "",
        ...
        },
        {
            ...
            subtitle: "Iraya Energies",
            desc: [`• Led the rapid prototyping of groundbreaking products, leveraging cutting-edge technologies in document,
...
and extract valuable insights, paving the way for enhanced productivity and informed decision-making.`],
            type: "Kuala Lumpur, Malaysia",
            tools_tech: "",
        ...
        {
            title: "WebGIS Specialist",
            subtitle: "Iraya Energies",
            desc: [`• Designed and developed a groundbreaking satellite distribution system, revolutionizing access to raw and
...
explore diverse capabilities and maximize their impact.`],
            type: "Metro Manila, Philippines",
            tools_tech: "",
    ...
    gisdev:[
        {
            ...
            subtitle: "Iraya Energies",
            desc: [`• Spearheaded the ideation, creation, and development of ElasticDocs, a flagship product that revolutionizes data
            ...
            experiments, features, and visualizations, driving a competitive edge for the product in the domain.`],
            type: "",
            tools_tech: `Leaflet.js, turf.js, deck.gl, d3,js, Chart.js, NodeJS, JavaScript, HTML, CSS, Vue.js, Vuetify, AdobeXD,
            Figma, Miro, Python, QGIS, GDAL`,
            date: "",
            award: "",
            images: [],
            links: []
        },
        {
            title: "Intuition: 3D image analog explorer",
            subtitle: "Iraya Energies",
            desc: [`A feature that allows exploration of thousand image vectors simultaneously in 2D and 3D spaces. This
        ...
        },
        {
            title: "Search Result Heatmap",
            subtitle: "Iraya Energies",
            desc: [`A webGIS interface that spatially visualizes information richness, providing clear search query relevance
            and context. This interface takes in geotagged search results and their frequencies to interpolate and
            generate a raster canvas image for the currently displayed map boundaries highlighting hotspots.`],
            type: "",
            tools_tech: `Leaflet.js, turf.js, JavaScript`,
            date: "",
            award: "",
        ...
        {
            title: "Well & Publication Knowledge Graph and Generator",
            subtitle: "Iraya Energies",
            desc: [`A network graph feature that unveils valuable insights into intricate relationships, guiding intuitive
        ...
        {
            title: "Yield Estimation System for Sugarcane (SRA YESS) Project",
            subtitle: "Sugar Regulatory Administration",
            desc: [`• Designed and developed the client and management interface of a webGIS platform, providing unprecedented
            ...
            satellite image on the map. Processed drone images are also available as one of the map overlays.`],
            type: "",
            tools_tech: `Leaflet.js, turf.js, Chart.js, NodeJS, JavaScript, HTML, CSS, Figma, QGIS, GDAL`,
            date: "",
            award: "",
            images: [],
            links: []
        },
        {
            ...
            subtitle: "PHL-Microsat (Philippine Microsatellite Project)",
            desc: [`Created to continuously track the satellite’s movement to plan missions, image captures jobs, and
            coordinate calibration and ground operations.`],
            type: "",
            tools_tech: `Leaflet.js, turf.js, d3.js, NodeJS, JavaScript, HTML, CSS`,
            date: "",
            award: "",
            images: [],
            links: []
        ...
        {
            title: "Diwata-1 Satellite Image Request and Distribution Platform",
            subtitle: "PHL-Microsat (Philippine Microsatellite Project)",
            desc: [`Created to manage requests for image capture jobs based on real-time satellite positions, unlocking new possibilities
            for harnessing satellite data in different applications in the Philippines.`],
            type: "",
            tools_tech: `Leaflet.js, turf.js, d3.js, NodeJS, JavaScript, HTML, CSS`,
            date: "",
            award: "",
        ...
        {
            title: "Pasil B and C Hydroelectric Power Project",
            subtitle: "FilGeosolutions Inc.",
            desc: [`WebGIS application provides essential field decision support, integrating spatial information, profiles, and
            documentation.`],
            type: "",
            tools_tech: `Leaflet.js, NodeJS, JavaScript, HTML, CSS`,
            date: "",
            award: "",
            images: [],
            links: []
        ...
        {
            title: "National Greening Program Application",
            subtitle: "FilGeosolutions Inc.",
            desc: [`Web-mapping platform to monitor nationwide reforestation efforts to meet national environmental goals.`],
            type: "",
            tools_tech: `Leaflet.js, NodeJS, JavaScript, HTML, CSS`,
            date: "",
            award: "",
        ...
        {
            title: "PhilSHORE: Tidal Current Energy Integrated Resource Assessment and Spatial Planning",
            subtitle: "Training Center for Applied Geodesy and Photogrammetry",
            desc: [`• Designed and developed four key modules of the marine spatial platform, enabling comprehensive decisionmaking and analysis. revolutionizing marine energy spatial planning.`,`• Facilitated stakeholder consultations to meet user requirements and foster a user-centric approach.
...
export const aboutSummary = {
    "dataViz": `I am a data visualization specialist who excels in utilizing technology within the realms of energy, geospatial data,
    ...
    thinking to address intricate challenges with solutions that prioritize human needs.`,
    "product": `A versatile professional skilled in leveraging technology across energy, geospatial data, visualization, and humancentered design. Driven by a deep passion for data, design, and technology, I transform them into actionable
...
export const aboutEducation = [
    {
        degree: "Post Graduate Certificate in Product Management",
        desc: "",
        school: "Northwestern University - Kellogg School of Management",
    },
    {
        degree: "Master of Science in Energy Engineering",
        desc: "Electives on Object-Oriented programming for Spatial Applications",
        school: "University of the Philippines",
    },
    {
        degree: "Research Exchange Fellow, Energy Materials",
        desc: "",
        school: "National Chiao Tung University, Taiwan",
    },
    {
        degree: "Bachelor of Science in Geodetic Engineering",
        desc: "Program and research focusing on Remote Sensing, Photogrammetry, Geographic Information Science and Cartography",
        school: "University of the Philippines",
    }
]

export const aboutPublication = [
    {
        title:"Supporting the UN 2050 Net Zero goal by reading the earth better​",
        authors:"N. M. Hernandez, K. G. Maver, and C. Mamador​",
        publication:"First Break, Volume 39, Issue 6, Jun 2021, p. 63 – 67​",
    },
    {
        title:"Accelerating E&P decisions by applying AI to unstructured data ​",
        authors:"K. G. Maver, C. Mamador, F. Baillard",
        publication:"First Break, Volume 38, Issue 12, Dec 2020, p. 67 – 70​",
    },
    {
        title:"A geological regional case study for pressure, temperature, and salinity for the GOM using machine learning technology on unstructured data",
        authors:"C. Mamador, J. O. Aranda, N. E. Arif, N. M. Hernandez, F. Baillard",
        publication:"Conference proceedings, EAGE/AAPG digital subsurface for Asia Pacific conference, Sep 2020, volume 2020, p.1 – 4​",
    },
    {
        ...
        authors:"N.M. Hernandez, P.J. Lucañas, J.C. Graciosa, C. Mamador, L.C.I. Panganiban, C. Yu, K.G. Maver, M.G. Maver ​",
        publication:"Conference proceedings, First EAGE/PESGB workshop machine learning, Nov 2018, volume 2018, p.1 – 3",
    },
    {
        title:"Development of a multi-site and multi-device webgis-based tool for tidal current energy development ​",
        authors:"M. Ang, L. Panganiban, C. Mamador, O. De Luna, M. Bausas, J. Cruz​",
        publication:"23rd International Society for Photogrammetry and Remote Sensing Congress, July 2016​",
    },
    {
        title:"Philshore tool: a web-based marine spatial planning tool​",
        authors:"M. Ang, L. Panganiban, C. Mamador, O. De Luna, M. Bausas, J. Cruz ​",
        publication:"36th Asian Conference on Remote Sensing, October 2015​",
    },
    {
        title:"Webgis tool for visualizing elevation profiles for Pasil B and C hydroelectric power plan construction project in Kalinga, Ifugao ",
        authors:"C. Mamador, L. Panganiban ​",
        publication:"36th Asian Conference on Remote Sensing, October 2015​",
    },
    {
        title:"The use of multilevel remote sensing data in the technical pre-feasibility study: hydroelectric power project in Kalinga, Philippines ​",
        authors:"L. Correa, C. Mamador, L. Panganiban, A. Mamerto, R. Elaydo, M. Buendia​",
        publication:"36th Asian Conference on Remote Sensing, October 2015​",
    },
]

export const aboutSpeaking = [
    {
        title:"Supporting the UN 2050 Net Zero goal by reading the earth better​",
        event:"N. M. Hernandez, K. G. Maver, and C. Mamador​",
        date:"First Break, Volume 39, Issue 6, Jun 2021, p. 63 – 67​",
    },
...
export default {
    aboutWorkItems, aboutSummary, aboutEducation, aboutCategories, aboutPublication, aboutSpeaking,
}

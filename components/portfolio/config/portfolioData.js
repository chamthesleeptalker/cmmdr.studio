export const portfolio = {
    "dataViz": {
        ...
        works: [
            {
                src: require("@/assets/images/portfolio/img7.png"),
                title: "Flowers and Tracks: A visual and cartographic exploration",
                desc: "This data story invokes the readers curiosity regarding historical typhoon data in the west pacific region and how it has changed over the years because of climate change.",
                data: "RSMC Tokyo-Typhoon Center",
                date: "November 2022",
                page: "/flowers-and-tracks"
            },
            {
